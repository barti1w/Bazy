...
CREATE OR REPLACE PACKAGE REPORTS AS
    PROCEDURE GENERATE_MONTHLY(p_type IN VARCHAR2 DEFAULT NULL, p_meal IN VARCHAR2 DEFAULT NULL);
    PROCEDURE GENERATE_QUARTERLY(p_type IN VARCHAR2 DEFAULT NULL, p_meal IN VARCHAR2 DEFAULT NULL);
    PROCEDURE GENERATE_YEARLY(p_type IN VARCHAR2 DEFAULT NULL, p_meal IN VARCHAR2 DEFAULT NULL);
END REPORTS;
/

CREATE OR REPLACE PACKAGE BODY REPORTS AS
    PROCEDURE GENERATE_MONTHLY(p_type IN VARCHAR2 DEFAULT NULL, p_meal IN VARCHAR2 DEFAULT NULL) IS
    BEGIN
    ...
    PROCEDURE GENERATE_QUARTERLY(p_type IN VARCHAR2 DEFAULT NULL, p_meal IN VARCHAR2 DEFAULT NULL) IS
    BEGIN
    ...
    PROCEDURE GENERATE_YEARLY(p_type IN VARCHAR2 DEFAULT NULL, p_meal IN VARCHAR2 DEFAULT NULL) IS
    BEGIN
